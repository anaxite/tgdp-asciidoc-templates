...
****
This template includes writing instructions and boilerplate text that you can customize, use as-is, or completely replace with your own text. This text is indicated in {{double curly brackets}}. Make sure you replace the placeholders with your own text.
****
...
https://thegooddocsproject.dev/feedback/?template=API%20reference[feedback
