...
Use the _Related resources_ section to link out to helpful resources, such as xref:./template-code-of-conduct-response-plan.adoc[Code of Conduct response plan] and your xref:../our-team/template-our-team[Our team page].
