...
To provide feedback related to the Asciidoc version of the templates, https://github.com/anaxite/tgdp-asciidoc-templates/issues[open a GitHub issue^].
